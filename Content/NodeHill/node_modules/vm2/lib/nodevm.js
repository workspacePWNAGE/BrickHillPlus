...
class NodeVM extends VM {
	...
	constructor(options = {}) {
		...
		if (!cacheSandboxScript) {
			cacheSandboxScript = compileScript(BOOTSTRAP_FILENAME_PREFIX + 'setup-node-sandbox.js',
				`(function (host, data) { ${sources['setup-node-sandbox.js']}\n})`);
		}
