   ...
   */
    ...
    * ```
    ...
    setFace(faceId) {
        return __awaiter(this, void 0, void 0, function* () {
            this.faceId = faceId;
            return new PacketBuilder_1.default(PacketBuilder_1.PacketEnums.FaceBroadcast)
                .write("uint32", this.netId)
                .write("string", faceId)
                .broadcast();
        });
    ...
    _createFigures() {
        ...
        if (this.faceId) {
            new PacketBuilder_1.default(PacketBuilder_1.PacketEnums.FaceBroadcast)
                .write("uint32", this.netId)
                .write("string", this.faceId)
                .broadcastExcept([this]);
        }
